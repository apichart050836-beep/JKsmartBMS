...
import { Download, Upload, RefreshCw, AlertCircle, CheckCircle2, Terminal, Wifi, Bluetooth, Radio } from "lucide-react";
...
// split into its own file/chunk (see App.jsx's React.lazy import) so regular
// Dashboard users never download it at all, per explicit request to cut
// Render bandwidth (it was previously bundled into the shared vendor chunk
// unconditionally).
export default function ESPFirmwareInstaller() {
